...
public class CrossingInitialNotification {
    private static final String NOTIFICATION_TAG = "CrossingInitial";
    public static void notify(Context context) {
        final Resources res = context.getResources();
        final String title = context.getString(R.string.crossing_initial_notification_title);
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setDefaults(Notification.DEFAULT_ALL)
                .setStyle(new NotificationCompat.BigTextStyle().bigText(context.getString(R.string.crossing_initial_notification_text)))
                .setSmallIcon(R.drawable.ic_stat_alert_warning)
                .setContentTitle(title)
                .setContentText(context.getString(R.string.crossing_initial_notification_text))
